...
def send_upgrades(msisdn):
  ...
  pixel_suggestions = [
      messages.OpenUrlAction('View Details', 'reply:pixel2',
                             'https://store.google.com/us/product/pixel_2?hl=en-US')
  ]
  ...
  samsung_suggestions = [
      messages.OpenUrlAction('View Details', 'reply:samsung',
                             'https://www.samsung.com/my/smartphones/galaxy-j6-j600/SM-J600GZKGXME/')
  ]

  # send carousel of several devices
  card_contents = []
  card_contents.append(messages.CardContent('GOOGLE PIXEL 2',
                                            None,
                                            'https://storage.googleapis.com/xyz-group-images/pixel2.jpg',
                                            'MEDIUM',
                                            pixel_suggestions))

  card_contents.append(messages.CardContent('MOTOROLA G6 PLUS',
                                            None,
                                            'https://storage.googleapis.com/xyz-group-images/motorola_phone.jpg',
                                            'MEDIUM',
                                            motorola_suggestions))

  card_contents.append(messages.CardContent('SAMSUNG GALAXY J6',
                                            None,
