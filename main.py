...
def callback():
  ...
  # read the request body, character by character, from a stream.
  read_stream = request.stream.read()
  stream_str = ''
  for character in read_stream:
    stream_str = stream_str + character
...
def start_conversation():
  ...
  telco_bot.send_greeting(msisdn)
